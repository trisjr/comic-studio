...
Tong duoc cong qua MOI thu muc `run-panels-*`, nen mot panel phai chay lai
vong hai se co ratio ~2N.
...
def count_images_per_panel():
    ...
    run_dirs = sorted(MVP0.glob("run-panels-*"))
...
def main():
    ...
    print(f"Doc {len(run_dirs)} thu muc run-panels-* · "
