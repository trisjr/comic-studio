...
>
> `Owner` ghi **vai trò Comic Studio** chịu trách nhiệm thực thi, không ghi "Founder" ở mọi hàng — đội 1 người (CF-1.2 `[CHỐT]`) nên mọi hàng đều quy về anh ở cấp *Accountable*, và một bảng mà mọi ô là "Founder" thì không dùng được.
...
*Generated by Comic Studio — role `security-auditor`.*
