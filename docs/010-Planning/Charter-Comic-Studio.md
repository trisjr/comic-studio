...
| **Manager** | **Founder (anh)** |
| **Đội thực thi** | **1 người (anh) + AI assist (TNMCORE-OS agents)**. Không funding, không ngân sách marketing `[CHỐT]` CF-1.2 |
...
| Nhóm hoạt động | Founder | AI Agent (TNMCORE-OS) | Luật sư SHTT *(chưa engage)* | Model provider *(ngoài, không đàm phán)* | Design partner *(chưa có ai)* |
|---|---|---|---|---|---|
...
| **9. Quản trị tri thức & tài liệu** | **A** | **R** — mọi role TNMCORE-OS ghi findings, cập nhật MOC, giữ traceability | — | — | — |
...
_Generated by TNMCORE-OS — role `business-analyst`._
_Author: trisjr_
