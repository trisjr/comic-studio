...
- [Analysis-MVP0-Requirements](./Analysis-MVP0-Requirements.md) — Phân tích yêu cầu **MVP0**: hợp nhất phạm vi + kỷ luật + hai lớp điều kiện ra (`P-1…P-6` artifact và `G1-a…G1-e` ngưỡng), ma trận truy vết 8 Story × tiêu chí, đánh giá **sẵn sàng thực thi** (8 điều kiện tiên quyết, 3 cái còn ⛔ trống), 6 phát hiện lệch giữa bốn tầng tài liệu, và 5 câu hỏi mở cần Founder đóng. `status: draft`.
...
Cả ba thư mục đã được tạo trong run `2026-08-23-khoi-tao-tai-lieu-planning-comic-studio` theo cấu trúc bắt buộc của RULE-001.

| Thư mục | Nội dung dự kiến | Trạng thái |
|---|---|---|
| [Competitor-Analysis/](./Competitor-Analysis/) | `Competitor-{Name}.md` — hồ sơ từng đối thủ | *(chưa có tài liệu)* — bảng đối thủ hiện nằm gọn trong `Analysis-Market-Competitor-Landscape` §3 |
| [User-Interviews/](./User-Interviews/) | `Interview-{Date}-{Topic}.md` | *(chưa có tài liệu)* — ⚠️ đây là nơi lấp khoảng trống **willingness-to-pay**, khoảng trống nằm dưới nền câu hỏi "bán được không" |
| [Surveys/](./Surveys/) | `Survey-{Topic}.md` | *(chưa có tài liệu)* |
