...
| **Font sẽ render** (họ font, glyph coverage tiếng Việt) | Story ghi lỗi *"font không đủ glyph"* là một rủi ro phải phát hiện **bằng kiểm thủ công**, vì ⛔ **không có benchmark định lượng nào** cho trường hợp này | **Architect + Founder**, sau MVP0 | Trước gate `G1-e` |
...
| **Font render** (họ font + glyph coverage tiếng Việt) | [Story-Typeset-Layer-And-Bubble-Overlay](../../022-User-Stories/Backlog/Story-Typeset-Layer-And-Bubble-Overlay.md) §Edge case | **Architect + Founder**, sau đo MVP0 |
