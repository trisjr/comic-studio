...
| **mới** | ⭐ **Cơ chế render an toàn của compositor** (`C-10`, `TM-F6-3`) — ⛔ chưa chọn được vì `SRS-NFR-09` còn `TBD` | **Architect**, lô API / `Spec-Integration-*` | Trước khi compositor đầu tiên chạy |
